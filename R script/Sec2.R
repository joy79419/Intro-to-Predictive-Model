...
Data = read.table("C:/Joey/Intro to Predictive Model/dataset/RunsPerGame.txt",header=T)
attach(Data)
...
House = read.table("C:/Joey/Intro to Predictive Model/dataset/housedata.txt",header=T)
attach(House)
...
SalaryData = read.table("C:/Joey/Intro to Predictive Model/dataset/SalaryData.txt",header=T)
...
MidCity = read.csv("C:/Joey/Intro to Predictive Model/dataset/MidCity.csv",header=T)
attach(MidCity)
...
Tele = read.table("C:/Joey/Intro to Predictive Model/dataset/Tele.txt",header=T)
attach(Tele)
...
OJ = read.table("C:/Joey/Intro to Predictive Model/dataset/OJ.txt",header=T)
attach(OJ)
...
Data = read.table("C:/Joey/Intro to Predictive Model/dataset/Airline.txt",header=T)
attach(Data)
...
ca <- read.csv("C:/Joey/Intro to Predictive Model/dataset/CAhousing.csv")
...
coef(CV.L,s="lambda.1se")[which(coef(CV.L,s="lambda.1se")!=0)]
colnames(XXca)[which(coef(CV.L,s="lambda.1se")!=0)]
...
food = read.csv("C:/Joey/Intro to Predictive Model/dataset/protein.csv", row.names=1) # 1st column is country name
xfood = scale(food) 
...
votes <- read.csv("C:/Joey/Intro to Predictive Model/dataset/rollcall-votes.csv")
legis <- read.csv("C:/Joey/Intro to Predictive Model/dataset/rollcall-members.csv")
